...
export class ProcessingManager {
  ...
  public async processDocument(
    ...
    this.startProcessing(processId, document, options).catch(error => {
    ...
    if (progress) {
      ...
      supabase.from('processing_status')
        ...
        .then(() => {
          ...
          supabase.channel('processing_updates')
            .send({
              type: 'broadcast',
