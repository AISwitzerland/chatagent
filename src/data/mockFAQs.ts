...
export const mockFAQs: FAQ[] = [
  {
    ...
    languages: {
      ...
      it: {
        ...
        answer:
          "Il premio mensile dell'assicurazione di base varia secondo il cantone, la franchigia e il modello assicurativo. Con una franchigia di CHF 300, il premio è compreso tra CHF 250 e CHF 400 al mese per gli adulti. Scegliendo una franchigia più alta (max. CHF 2500), è possibile risparmiare fino al 40% sui premi.",
      },
    },
  },
  {
    ...
    languages: {
      ...
      en: {
        ...
        answer:
          'The premium is based on the sum insured and living space. For a 3-room apartment (75m²) with an insurance sum of CHF 100,000, the annual premium is approximately CHF 200-300. Additional coverage like valuables or natural hazards increases the premium. A deductible of CHF 200 is standard. Burglary protection measures can lead to premium discounts of up to 15%.',
      },
      fr: {
        question: "Comment la prime d'assurance ménage est-elle calculée?",
        answer:
          "La prime est basée sur la somme assurée et la surface habitable. Pour un appartement de 3 pièces (75m²) avec une somme d'assurance de CHF 100'000, la prime annuelle est d'environ CHF 200-300. Les couvertures supplémentaires augmentent la prime. Une franchise de CHF 200 est standard.",
      },
      it: {
        question: "Come si calcola il premio dell'assicurazione economia domestica?",
        answer:
          "Il premio si basa sulla somma assicurata e sulla superficie abitativa. Per un appartamento di 3 locali (75m²) con una somma assicurata di CHF 100'000, il premio annuale è di circa CHF 200-300. Le coperture supplementari aumentano il premio. Una franchigia di CHF 200 è standard.",
      },
    },
  },
  {
    ...
    answer:
      "Die Prämie wird durch mehrere Faktoren bestimmt: Fahrzeugtyp, Alter des Fahrzeugs, PS-Zahl, Schadenfreiheitsrabatt (Bonus bis 70%), Alter des Fahrers und Wohnort. Beispiel: Ein VW Golf (130 PS, Neuwert CHF 35'000) kostet mit Vollkasko für einen 35-jährigen Fahrer mit 5 Jahren unfallfreiem Fahren ca. CHF 800-1'200 pro Jahr. Die Teilkasko liegt etwa 40% darunter. Der Selbstbehalt beträgt bei Vollkasko CHF 1'000, bei Teilkasko CHF 500.",
    languages: {
      de: {
        question: 'Welche Faktoren beeinflussen die Autoversicherungsprämie?',
        answer:
      ...
      en: {
        ...
        answer:
          'The premium is determined by several factors: vehicle type, age of vehicle, horsepower, no-claims discount (bonus up to 70%), driver age, and residence. Example: A VW Golf (130 HP, new value CHF 35,000) with comprehensive coverage costs approx. CHF 800-1,200 per year for a 35-year-old driver with 5 years of accident-free driving.',
      },
      fr: {
  ...
  },
  {
    ...
    answer:
      'Eine Privathaftpflichtversicherung mit einer empfohlenen Deckungssumme von CHF 5 Millionen kostet für einen Einzelhaushalt ca. CHF 100-150 pro Jahr, für Familien CHF 150-200. Die Deckung umfasst Personen-, Sach- und Vermögensschäden. Zusätzliche Optionen wie Schlüsselverlust oder Mietkaution erhöhen die Prämie um ca. CHF 20-50. Der übliche Selbstbehalt beträgt CHF 200. Mieter sollten unbedingt Mieterschäden einschließen.',
    languages: {
      de: {
        question: 'Was kostet eine Privathaftpflichtversicherung und welche Deckung ist empfohlen?',
        answer:
      ...
      en: {
        question:
          'How much does personal liability insurance cost and what coverage is recommended?',
        answer:
          'Personal liability insurance with a recommended coverage of CHF 5 million costs approx. CHF 100-150 per year for individuals, CHF 150-200 for families. Coverage includes personal injury, property damage, and financial losses. Additional options like key loss or rental deposit increase the premium by CHF 20-50.',
      },
      fr: {
        question:
          'Combien coûte une assurance responsabilité civile privée et quelle couverture est recommandée?',
        answer:
          'Une assurance RC privée avec une couverture recommandée de CHF 5 millions coûte env. CHF 100-150 par an pour une personne seule, CHF 150-200 pour les familles. La couverture comprend les dommages corporels, matériels et financiers.',
      },
      it: {
        question:
          "Quanto costa un'assicurazione responsabilità civile privata e quale copertura è consigliata?",
        answer:
          "Un'assicurazione RC privata con una copertura consigliata di CHF 5 milioni costa circa CHF 100-150 all'anno per una persona sola, CHF 150-200 per le famiglie. La copertura include danni fisici, materiali e finanziari.",
      },
    },
  },
  {
